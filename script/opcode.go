...
var opcodeArray = [256]opcode{
	...
	OP_SPLIT:   {OP_SPLIT, "OP_SPLIT", 1},
	OP_NUM2BIN: {OP_NUM2BIN, "OP_NUM2BIN", 1},
	OP_BIN2NUM: {OP_BIN2NUM, "OP_BIN2NUM", 1},
	...
	// More crypto
	OP_CHECKDATASIG:       {OP_CHECKDATASIG, "OP_CHECKDATASIG", 1},
	OP_CHECKDATASIGVERIFY: {OP_CHECKDATASIGVERIFY, "OP_CHECKDATASIGVERIFY", 1},
